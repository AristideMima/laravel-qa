                    ...
                    <div class="card-body">
                        ...
                        <div class="media">
                            <div class="d-flex flex-column vote-controls">
                                <a title = "This question is useful" class="vote-up {{ Auth::guest() ? 'off':'' }}" href=""
                                ...
                                <a href="" title ="This question is not usable" class="vote-down {{ Auth::guest() ? 'off':'' }}"
                                ...
                                <a href="" title="click to mark as private question (Click again to undo)" class="favorite mt-2 {{ Auth::guest() ? 'off': ($question->is_favorited ? 'favorited' : '')}}"
